...
public class FindPincode extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_pincode);
...
//        });
        ...
        progressDialog = new ProgressDialog(FindPincode.this);
    ...
    private void openURL() {
        ...
        progressDialog.show();
        webView.loadUrl("https://www.indiapost.gov.in/sites/DOPMobile/Pages/FindPin.aspx");
